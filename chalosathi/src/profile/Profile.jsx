...
function Profile() {
    const { user: clerkUser, isSignedIn } = useAuthContext(); // Get Clerk user from context
    const { getToken } = useAuth();
    const [profile, setProfile] = useState(null); // Store the user profile from MongoDB
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await fetch("http://localhost:5002/api/users/update", {
                ...
                body: JSON.stringify({
                    clerkUserId: clerkUser.id, // Use clerkUser.id
                    name: newName,
                    userType,
                }),
            });
            ...
            <div className="bg-[#1b252f] p-6 rounded-lg shadow-lg w-full max-w-md text-center">
                ...
                <div className="avatar flex justify-center">
                    <div className="w-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2">
                        <img
                            src={clerkUser.imageUrl} // Keep Clerk image
                            alt="Profile"
