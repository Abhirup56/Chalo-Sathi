    ...
    <>
      ...
      <div className='flex h-screen items-center justify-center flex-col relative bottom-5 '>
          ...
          <h1 className='text-3xl text-Blue font-dance mb-7'>
              ...
              <button className='btn btn-info text-White w-full py-2 rounded-md '>Login</button>
              <hr />
              <p className='text-sm'>Don't have an account ? <a href="/login" className='text-Blue underline'>Signin</a>
              </p>
          </form>
      </div>
